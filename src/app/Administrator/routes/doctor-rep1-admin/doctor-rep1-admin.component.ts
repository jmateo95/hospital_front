...
@Component({
  selector: 'app-doctor-rep1-admin',
  templateUrl: './doctor-rep1-admin.component.html',
  styleUrls: ['./doctor-rep1-admin.component.css']
})
export class DoctorRep1AdminComponent implements OnInit {
  breakpoint = 3;
  hidepicture = false;
  ...
  ngOnInit() {
    ...
    console.log(start);
    console.log(end);
    this.citasService.getCitaDoctor(false, start, end).subscribe(
      res=>{         
        console.log(res);
        this.datos=res;
